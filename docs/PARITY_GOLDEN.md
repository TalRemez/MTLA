...
## COCO detection (InternVL3.5-8B), slot=all, band L8-21
- Hallucination AUROC (seed 0, 43139 preds): MTLA **0.8730**, SVAR **0.8031**

## QVHighlights (Qwen3-VL-8B), N=16, agg=max, slot=first_digit
...
## Charades-STA (Qwen3-VL-8B), N=16, agg=max, slot=first_digit
